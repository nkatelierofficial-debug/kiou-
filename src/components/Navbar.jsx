  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-white sticky-top shadow-sm py-2">
      <div className="container">
        <a className="navbar-brand d-flex align-items-center ms-2 ms-md-4" href="#hero">
          <img 
            src={logoImg} 
            alt="KIOU Logo" 
        ...
        <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
          <ul className="navbar-nav align-items-center gap-3">
            ...
            <li className="nav-item">
              <a href="#contact" className="btn btn-primary rounded-pill px-4 text-white fw-semibold">
                Contact Us
              </a>
            </li>
          </ul>
